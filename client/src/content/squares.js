...
export default [
    ...
    {image: cardinal, label: 'Ecocritical Creativity', path: 'ecocritical-creativity'},
    {image: tiredCat, label: 'Essay Topography', path: 'essay-topography'},
    {image: basketCat, label: 'Writing and Reality', path: 'writing-and-reality'},
